...
const LOCALES = {
  ja: {
    ...
    "review.title": "💪 にがて分野",
    "review.desc": "まちがえた問題は、翌日・3日後・7日後・20日後にもう一度出ます。正解できたら次の間かくへ進み、4回とも正解したら卒業してこの一覧から消えます。毎日やらなくても間かくは崩れません。",
  ...
  es: {
    ...
    "review.desc": "Las preguntas falladas vuelven a salir al día siguiente y a los 3, 7 y 20 días. Cada acierto pasa al siguiente intervalo y, tras acertar las cuatro veces, la pregunta desaparece de esta lista. Los intervalos se respetan aunque no se juegue todos los días.",
    "review.empty": "Ahora mismo no hay nada pendiente de repasar.",
    "review.dueToday": "Sale hoy",
    "review.dueLater": "En {n} día(s)",
    "review.wrongCount": "Fallada {n} vez/veces",
