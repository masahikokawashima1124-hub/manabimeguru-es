...
const LOCALES = {
  ja: {
    ...
    "todayQ.title": "🍚 きょうの1問",
    "todayQ.desc": "お子さんが今日つまずいた問題を1問だけ出します。夕ごはんのときなどに、口で出し直してみてください。こたえを見ずに答えられたら、そこは定着したということです。",
    "todayQ.locked": "アカウント登録すると、お子さんが今日つまずいた問題が見られます。",
    ...
    "todayQ.showAnswer": "こたえを見る",
    "todayQ.hideAnswer": "こたえをかくす",
    "todayQ.noAnswerYet": "※ この問題は答えを記録する前のものです。次にまちがえたときから答えも出ます。",
    "review.title": "💪 にがて分野",
    ...
    "review.dueToday": "きょう出ます",
    // 日本語は単複で形が変わらないので One も同じ文言。スペイン語側で使い分ける
    "review.dueLater": "あと{n}日",
    "review.dueLaterOne": "あと1日",
    "review.wrongCount": "まちがえた回数 {n}回",
    "review.wrongCountOne": "まちがえた回数 1回",
    "review.stage": "{current}/{total}回目",
    "review.summary": "復習中 {n}件（うち きょう出るぶん {due}件）",
    "review.group": "{subject} {n}件（きょう出るぶん {due}件）",
    ...
    // --- 復習リマインド（account-design.md §10-13） ---
    "reviewNotify.title": "📮 復習リマインド",
    "reviewNotify.desc": "アプリを開かない日が続くと、復習の期日が来ても気づけません。期日が来た日に、メールでお知らせします（有料会員限定）。",
    "reviewNotify.freeNote": "復習リマインドは有料会員（ファミリープラン）の機能です。",
    "reviewNotify.toggleLabel": "期日が来たらメールで知らせる",
    "reviewNotify.paidNote": "1日1通まで、期日が来た日だけ送ります。お子さまの回答内容は本文に含めません。いつでもオフにできます。",
    ...
    "profile.addLocked": "ふやせるのは プレミアムプラン",
    "profile.addFull": "{n}人まで つくれます",
    ...
    "profile.manage": "けす",
    "profile.rename": "なまえを かえる",
    "profile.renameBtn": "かえる",
    "profile.renameTitle": "なまえを かえる",
    "profile.renameSub": "あたらしい なまえを おしえてね",
    "profile.renameOk": "かえる",
    ...
    // --- おためし（未登録で使う） ---
    "auth.storageBlocked": "この端末では、まなびめぐるのデータを保存できない設定になっているようです。ブラウザのサイトデータの設定（シークレットモードや、サイトデータの保存をブロックする設定）をご確認ください。",
    ...
    "quiz.fractionPlaceholder": "れい: 3/4",
    "quiz.submit": "こたえる",
    "quiz.next": "つぎへ",
    ...
    "quiz.badgeReview": "💪 まえに まちがえた もんだい",
    "quiz.reviewCleared": "まえは まちがえた もんだいだよ。よく できたね！",
    ...
    "cat.flash": "たしざんダッシュ",
    "cat.flashDesc": "すうじが つぎつぎ出る。ぜんぶ たしてね",
    "flash.title": "⚡ たしざんダッシュ",
    "flash.desc": "すうじが 1つずつ 出てきます。ぜんぶ たした こたえを 入力してね。",
    "flash.rule": "{digits}けたの すうじが {count}こ ながれます。ぜんぶで {rounds}かい。",
    "flash.best": "じこベスト：{total}かい中 {n}かい せいかい",
    "flash.noBest": "まだ きろくが ありません。さいしょの きろくを つくろう！",
    "flash.speed.slow": "🐢 ゆっくり",
    "flash.speed.normal": "🚶 ふつう",
    "flash.speed.fast": "🐇 はやい",
    "flash.start": "スタート！",
    "flash.progress": "{n}かいめ／{total}かい",
    "flash.answerPlaceholder": "こたえは？",
    "flash.submit": "こたえる",
    "flash.correct": "せいかい！",
    "flash.wrong": "おしい！こたえは {answer}",
    "flash.score": "{total}かい中 {n}かい せいかい！",
    "flash.gotPoints": "🎰 {n}ポイント ゲット！",
    "flash.capped": "きょうの たしざんダッシュの ポイントは {n}ポイントまでです。",
    "flash.newBest": "🎉 じこベスト こうしん！",
    "flash.again": "もう いっかい",
    "flash.quit": "やめる",
    "cat.kanji": "かんじ",
    ...
    "guide.flash": [
      "すうじを よく見てね。ぜんぶ たしたら こたえだよ！",
      "まえから じゅんばんに たしていくと できるよ！",
    ],
    "guide.correct": [
      "せいかい！すごいね！",
      "やったね！そのちょうし！",
    ...
    "quiz.listen": "🔊 「{text}」を 聞く",
    "quiz.listenSentence": "🔊 この文を 聞く",
  ...
  es: {
    ...
    "todayQ.title": "🍚 La pregunta de hoy",
    "todayQ.desc": "Te mostramos una sola pregunta que se le ha resistido hoy. Prueba a planteársela de viva voz, por ejemplo durante la cena. Si la contesta sin ver la solución, es señal de que ya la tiene asentada.",
    "todayQ.locked": "Crea una cuenta para ver la pregunta que se le ha resistido hoy.",
    ...
    "todayQ.showAnswer": "Ver la respuesta",
    "todayQ.hideAnswer": "Ocultar la respuesta",
    "todayQ.noAnswerYet": "* Esta pregunta es anterior a que se guardaran las respuestas. A partir del próximo fallo también se mostrará.",
    ...
    "review.dueToday": "Sale hoy",
    "review.dueLater": "En {n} días",
    "review.dueLaterOne": "Mañana",
    "review.wrongCount": "Fallada {n} veces",
    "review.wrongCountOne": "Fallada 1 vez",
    "review.stage": "Repaso {current} de {total}",
    "review.summary": "{n} en repaso ({due} para hoy)",
    "review.group": "{subject}: {n} ({due} para hoy)",
    ...
    // --- Recordatorio de repaso (account-design.md §10-13) ---
    "reviewNotify.title": "📮 Recordatorio de repaso",
    "reviewNotify.desc": "Si pasan varios días sin abrir la app, es fácil que no te enteres de que toca repasar. Te avisamos por correo el día que toque (función de pago).",
    "reviewNotify.freeNote": "El recordatorio de repaso es una función del plan familiar de pago.",
    "reviewNotify.toggleLabel": "Avisarme por correo cuando toque repasar",
    "reviewNotify.paidNote": "Como máximo un correo al día, solo el día que toque repasar. El correo no incluye las respuestas de tu hijo/a. Puedes desactivarlo cuando quieras.",
    ...
    "profile.manageTitle": "¿Cuál quieres borrar?",
    ...
    "profile.addLocked": "Añadir perfiles es del plan Premium",
    "profile.addFull": "Puedes crear hasta {n}",
    ...
    "profile.rename": "Cambiar el nombre",
    "profile.renameBtn": "Cambiar",
    "profile.renameTitle": "Cambiar el nombre",
    "profile.renameSub": "¿Cómo quieres llamarte?",
    "profile.renameOk": "Cambiar",
    ...
    // --- おためし（未登録で使う） ---
    "auth.storageBlocked": "Parece que este dispositivo no permite guardar los datos de Manabimeguru. Revisa los ajustes del navegador (modo incógnito o bloqueo de datos de sitios).",
    ...
    "quiz.fractionPlaceholder": "ej.: 3/4",
    ...
    "quiz.badgeReview": "💪 Antes la fallaste",
    "quiz.reviewCleared": "¡Antes la fallaste y ahora te ha salido! ¡Muy bien!",
    ...
    "cat.flash": "Carrera de sumas",
    "cat.flashDesc": "Van saliendo números. ¡Súmalos todos!",
    "flash.title": "⚡ Carrera de sumas",
    "flash.desc": "Los números van saliendo de uno en uno. Escribe la suma de todos ellos.",
    "flash.rule": "Salen {count} números de {digits} cifra(s). Son {rounds} rondas en total.",
    "flash.best": "Tu récord: {n} de {total} aciertos",
    "flash.noBest": "Aún no hay récord. ¡Marca el primero!",
    "flash.speed.slow": "🐢 Lento",
    "flash.speed.normal": "🚶 Normal",
    "flash.speed.fast": "🐇 Rápido",
    "flash.start": "¡Empezar!",
    "flash.progress": "Ronda {n} de {total}",
    "flash.answerPlaceholder": "¿Cuánto suma?",
    "flash.submit": "Responder",
    "flash.correct": "¡Correcto!",
    "flash.wrong": "¡Casi! La respuesta era {answer}",
    "flash.score": "¡{n} de {total} aciertos!",
    "flash.gotPoints": "🎰 ¡Has ganado {n} puntos!",
    "flash.capped": "Hoy ya has llegado al máximo de {n} puntos con la carrera de sumas.",
    "flash.newBest": "🎉 ¡Nuevo récord!",
    "flash.again": "Otra vez",
    "flash.quit": "Salir",
    ...
    "guide.flash": [
      "¡Fíjate bien en los números! Suma todos y dime cuánto da.",
      "Ve sumando de uno en uno, empezando por el primero. ¡Así es más fácil!",
    ],
    "guide.correct": [
      "¡Correcto! ¡Qué bien!",
      "¡Muy bien! ¡Sigue así!",
    ...
    "quiz.listen": "🔊 Escuchar «{text}»",
    "quiz.listenSentence": "🔊 Escuchar la frase",
    ...
    "math.decimal3.hint": "Alinea las comas decimales y luego calcula.",
    ...
    "math.wordSub.text": "Había {bigger} {item}, pero {past} {b}. ¿{howMany} quedan?",
    ...
    "math.wordDecimalAmount4.hintAdd": "Alinea las comas decimales y suma.",
    "math.wordDecimalAmount4.explainAdd": "{a}+{b}={sum} ({unit})",
    ...
    "math.listSeparator": ", ",
    "math.itemSeparator": ", ",
    "math.decimalMul5.hint": "Multiplica como si no hubiera coma decimal y al final vuelve a ponerla.",
    "math.decimalMul5.explain": "{a10} × {b} = {raw}. Corriendo la coma decimal un lugar sale {answer}.",
    "math.decimalDiv5.hint": "La coma decimal del dividendo pasa igual al cociente.",
  ...
  de: {
    ...
    // --- Wiederholungs-Erinnerung (account-design.md §10-13) ---
    "reviewNotify.title": "📮 Wiederholungs-Erinnerung",
    "reviewNotify.desc": "Wenn die App mehrere Tage nicht geöffnet wird, bleibt eine fällige Wiederholung leicht unbemerkt. Wir informieren dich per E-Mail, sobald sie fällig ist (kostenpflichtige Funktion).",
    "reviewNotify.freeNote": "Die Wiederholungs-Erinnerung ist eine Funktion des kostenpflichtigen Familienplans.",
    "reviewNotify.toggleLabel": "Per E-Mail benachrichtigen, wenn eine Wiederholung fällig ist",
    "reviewNotify.paidNote": "Höchstens eine E-Mail pro Tag, nur an Tagen mit fälliger Wiederholung. Die Antworten deines Kindes stehen nicht im Text. Jederzeit abschaltbar.",
    ...
    "profile.manageTitle": "Welches Profil löschen?",
    ...
    "profile.addLocked": "Weitere Profile gibt es im Premium-Tarif",
    "profile.addFull": "Bis zu {n} Profile möglich",
...
//
// 算数の問題は毎回ランダム生成なので「間違えた問題」を保存しても再現できない。
// そのかわり生成器（＝単元）を記録しているので、それを人が読める名前にする。
// キーは script.js の生成器の関数名。ここに無い名前は分野名にフォールバックする。
const MATH_GEN_LABELS = {
  ja: {
    genAdd1: "たしざん（1年）", genSub1: "ひきざん（1年）",
    genAdd2: "たし算（2年）", genSub2: "ひき算（2年）", genMul2: "かけ算（九九）",
    genAdd3: "たし算の筆算", genSub3: "ひき算の筆算", genMul3: "かけ算（3年）",
    genDiv3: "わり算", genDivRemainder3: "あまりのあるわり算",
    genDecimal3: "小数のたし算・ひき算（3年）", genFractionSame3: "分数のたし算・ひき算（分母が同じ）",
    genRounding4: "がい数・四捨五入", genDivLong4: "わり算の筆算",
    genDecimalAddSub4: "小数のたし算・ひき算（4年）", genRectArea4: "長方形・正方形の面積",
    genAngle4: "角の大きさ",
    genDecimalMul5: "小数のかけ算", genDecimalDiv5: "小数のわり算",
    genFractionAddDiff5: "分数のたし算・ひき算（通分）", genPercent5: "割合・百分率",
    genAverage5: "平均", genTriangleArea5: "三角形の面積",
    genFractionMul6: "分数のかけ算", genFractionDiv6: "分数のわり算",
    genCircleArea6: "円の面積", genVolume6: "体積", genRatio6: "比",
    genProportion6: "比例", genCombination6: "場合の数",
    genWordAdd: "たし算の文章題", genWordSub: "ひき算の文章題",
    genWordAddSub1: "たし算・ひき算の文章題（1年）", genWordSubDiff1: "ちがいをもとめる文章題",
    genWordAddCombine: "あわせていくつの文章題", genWordCompare: "大きさくらべの文章題",
    genWordMul: "かけ算の文章題", genWordDiv: "わり算の文章題",
    genWordMulArray2: "かけ算（〇こずつ）の文章題", genWordLength2: "長さの文章題",
    genWordDivRemainder3: "あまりのあるわり算の文章題",
    genWordUnit4: "単位の文章題", genWordBigNumber4: "大きな数の文章題",
    genWordEstimate4: "がい数の文章題", genWordDivLarge4: "大きな数のわり算の文章題",
    genWordAreaRoom4: "面積の文章題", genWordProportion4: "変わり方の文章題",
    genWordDecimalAmount4: "小数（かさ・重さ）の文章題",
    genWordAverage5: "平均の文章題", genWordPercent5: "割合の文章題",
    genWordPerUnit5: "1あたりの量の文章題", genWordDensity5: "こみぐあいの文章題",
    genWordMultiple5: "公倍数の文章題", genWordDivisor5: "公約数の文章題",
    genWordSpeed: "速さの文章題", genWordCircle6: "円の文章題",
    genWordFractionMul6: "分数のかけ算の文章題", genWordRatioFind6: "比の文章題",
    genWordRatioSplit6: "比で分ける文章題", genWordInverse6: "反比例の文章題",
    genWordCombinationPick6: "場合の数の文章題",
  },
  es: {
    genAdd1: "Sumas (1.º)", genSub1: "Restas (1.º)",
    genAdd2: "Sumas (2.º)", genSub2: "Restas (2.º)", genMul2: "Tablas de multiplicar",
    genAdd3: "Sumas en columna", genSub3: "Restas en columna", genMul3: "Multiplicaciones (3.º)",
    genDiv3: "Divisiones", genDivRemainder3: "Divisiones con resto",
    genDecimal3: "Sumas y restas con decimales (3.º)", genFractionSame3: "Fracciones con el mismo denominador",
    genRounding4: "Redondeo y aproximación", genDivLong4: "Divisiones en columna",
    genDecimalAddSub4: "Sumas y restas con decimales (4.º)", genRectArea4: "Área del rectángulo y del cuadrado",
    genAngle4: "Ángulos",
    genDecimalMul5: "Multiplicación de decimales", genDecimalDiv5: "División de decimales",
    genFractionAddDiff5: "Fracciones con distinto denominador", genPercent5: "Porcentajes y proporciones",
    genAverage5: "Media", genTriangleArea5: "Área del triángulo",
    genFractionMul6: "Multiplicación de fracciones", genFractionDiv6: "División de fracciones",
    genCircleArea6: "Área del círculo", genVolume6: "Volumen", genRatio6: "Razones",
    genProportion6: "Proporcionalidad", genCombination6: "Combinatoria",
    genWordAdd: "Problemas de sumar", genWordSub: "Problemas de restar",
    genWordAddSub1: "Problemas de sumar y restar (1.º)", genWordSubDiff1: "Problemas de diferencia",
    genWordAddCombine: "Problemas de juntar cantidades", genWordCompare: "Problemas de comparar",
    genWordMul: "Problemas de multiplicar", genWordDiv: "Problemas de dividir",
    genWordMulArray2: "Problemas de grupos iguales", genWordLength2: "Problemas de longitud",
    genWordDivRemainder3: "Problemas de división con resto",
    genWordUnit4: "Problemas de unidades", genWordBigNumber4: "Problemas de números grandes",
    genWordEstimate4: "Problemas de aproximación", genWordDivLarge4: "Problemas de división con números grandes",
    genWordAreaRoom4: "Problemas de área", genWordProportion4: "Problemas de variación",
    genWordDecimalAmount4: "Problemas con decimales (capacidad y peso)",
    genWordAverage5: "Problemas de media", genWordPercent5: "Problemas de porcentaje",
    genWordPerUnit5: "Problemas de cantidad por unidad", genWordDensity5: "Problemas de densidad",
    genWordMultiple5: "Problemas de múltiplos comunes", genWordDivisor5: "Problemas de divisores comunes",
    genWordSpeed: "Problemas de velocidad", genWordCircle6: "Problemas del círculo",
    genWordFractionMul6: "Problemas de multiplicar fracciones", genWordRatioFind6: "Problemas de razones",
...
function mathGenLabel(name) {
  const dict = MATH_GEN_LABELS[getLocale()] || MATH_GEN_LABELS[DEFAULT_LOCALE];
  return (dict && dict[name]) || (MATH_GEN_LABELS[DEFAULT_LOCALE] || {})[name] || null;
}
