...
const LOCALES = {
  ja: {
    ...
    "math.add2.hint": "たす数を 十と一に わけて、大きいほうから たしてみよう",
    "math.add2.explainSplit": "{b}は {bTensVal}と{bOnes}。{a}に {bTensVal}を たして {mid}。{mid}に {bOnes}を たして {sum}",
    "math.add2.explainRound": "{b}は ちょうど {bTensVal}。{a}に {bTensVal}を たして {sum}",
    "math.sub2.hint": "ひく数を 十と一に わけて、大きいほうから ひいてみよう",
    "math.sub2.explainSplit": "{b}は {bTensVal}と{bOnes}。{a}から {bTensVal}を ひいて {mid}。{mid}から {bOnes}を ひいて {diff}",
    "math.sub2.explainRound": "{b}は ちょうど {bTensVal}。{a}から {bTensVal}を ひいて {diff}",
  ...
  es: {
    ...
    "math.add2.hint": "Separa el número que sumas en decenas y unidades, y empieza por las decenas.",
    "math.add2.explainSplit": "{b} es {bTensVal} y {bOnes}. A {a} le sumas {bTensVal} y llegas a {mid}. A {mid} le sumas {bOnes}: {sum}.",
    "math.add2.explainRound": "{b} es justo {bTensVal}. A {a} le sumas {bTensVal}: {sum}.",
    "math.sub2.hint": "Separa el número que restas en decenas y unidades, y empieza por las decenas.",
    "math.sub2.explainSplit": "{b} es {bTensVal} y {bOnes}. A {a} le quitas {bTensVal} y llegas a {mid}. A {mid} le quitas {bOnes}: {diff}.",
    "math.sub2.explainRound": "{b} es justo {bTensVal}. A {a} le quitas {bTensVal}: {diff}.",
