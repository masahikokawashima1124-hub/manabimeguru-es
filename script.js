...
const CARD_POOL = [
  ...
  { id: "fuyu-r2", name: "つららのさかさぼう", rarity: "R", theme: "snow", shape: "egg", color: "#b3e5fc", accessory: "none", eye: "dot", flavor: "のきさきに さかさまに のびる、すきとおった ぼう", image: "fuyu-r2.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr1", name: "しもばしらのあしおと", rarity: "SR", theme: "snow", shape: "egg", color: "#9fd8df", accessory: "none", eye: "star", sparkle: true, flavor: "あさ いちばんに ふむと、さくさくと おとが なる", image: "fuyu-sr1.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-ur1", name: "ゆきげしきのえかき", rarity: "UR", theme: "snow", shape: "oval", color: "#f0f4f8", accessory: "none", eye: "star", sparkle: true, flavor: "ひとばんで まちを まっしろに ぬりかえる", image: "fuyu-ur1.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n3", name: "ゆきだるまのまるこ", rarity: "N", theme: "snowplay", shape: "round", color: "#fcfcfc", accessory: "none", eye: "dot", flavor: "あたまと からだ、ふたつの たまで できている", image: "fuyu-n3.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n4", name: "ゆきがっせんのたまや", rarity: "N", theme: "snowplay", shape: "round", color: "#e3f2fd", accessory: "ear-tufts", eye: "dot", flavor: "いちばん まるい ゆきだまを つくる めいじん", image: "fuyu-n4.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n5", name: "そりのすべりんこ", rarity: "N", theme: "snowplay", shape: "oval", color: "#ef5350", accessory: "none", eye: "star", flavor: "さかを いっきに すべりおりるのが なにより すき", image: "fuyu-n5.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r3", name: "かまくらのなかっこ", rarity: "R", theme: "snowplay", shape: "round", color: "#ffe0b2", accessory: "none", eye: "dot", flavor: "ゆきの いえの なかで、ろうそくを ともして まっている", image: "fuyu-r3.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r4", name: "あしあとのついてくる", rarity: "R", theme: "snowplay", shape: "round", color: "#90caf9", accessory: "none", eye: "dot", flavor: "だれかの あしあとを、そっと ついて あるく", image: "fuyu-r4.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr2", name: "ゆきやまのちょうじょう", rarity: "SR", theme: "snowplay", shape: "round", color: "#e8eaf6", accessory: "crown", eye: "closed", sparkle: true, flavor: "だれも のぼったことのない、まっしろな やまの てっぺん", image: "fuyu-sr2.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n6", name: "かがみもちのかさねっこ", rarity: "N", theme: "newyear", shape: "round", color: "#fff3e0", accessory: "none", eye: "dot", flavor: "おおきいのと ちいさいの、ふたつ かさなって すわっている", image: "fuyu-n6.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n7", name: "こまのまわりんぼ", rarity: "N", theme: "newyear", shape: "egg", color: "#d81b60", accessory: "none", eye: "star", flavor: "まわっている あいだだけ、まっすぐ たっていられる", image: "fuyu-n7.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n8", name: "たこあげのいととり", rarity: "N", theme: "newyear", shape: "oval", color: "#29b6f6", accessory: "tuft", eye: "dot", flavor: "そらの たかいところまで あがるのが ゆめ", image: "fuyu-n8.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r5", name: "おとしだまのぽちぶくろ", rarity: "R", theme: "newyear", shape: "oval", color: "#d32f2f", accessory: "none", eye: "dot", flavor: "なかみを あけるまで、だれにも わからない", image: "fuyu-r5.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r6", name: "はつもうでのぎょうれつ", rarity: "R", theme: "newyear", shape: "round", color: "#616161", accessory: "none", eye: "dot", flavor: "ながい ながい れつの いちばん うしろに いる", image: "fuyu-r6.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr3", name: "はつひのでのいちばんぼし", rarity: "SR", theme: "newyear", shape: "egg", color: "#ff8f00", accessory: "comb-gold", eye: "star", sparkle: true, flavor: "いちねんで いちばん さいしょの ひかりを つれてくる", image: "fuyu-sr3.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n9", name: "こたつのもぐりんこ", rarity: "N", theme: "warmth", shape: "round", color: "#f4511e", accessory: "none", eye: "sleepy", flavor: "いちど はいると、にどと でてこられない", image: "fuyu-n9.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n10", name: "みかんのむきじょうず", rarity: "N", theme: "warmth", shape: "round", color: "#ffa726", accessory: "none", eye: "dot", flavor: "かわを ひとつづきで むくのが じまん", image: "fuyu-n10.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n11", name: "なべのぐつぐつ", rarity: "N", theme: "warmth", shape: "round", color: "#6d4c41", accessory: "none", eye: "dot", flavor: "みんなが かこむと、いちばん げんきに なる", image: "fuyu-n11.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r7", name: "ゆたんぽのあしもと", rarity: "R", theme: "warmth", shape: "oval", color: "#ef9a9a", accessory: "none", eye: "closed", flavor: "ふとんの いちばん したで、あさまで あたためる", image: "fuyu-r7.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r8", name: "おでんのしみしみ", rarity: "R", theme: "warmth", shape: "round", color: "#a97142", accessory: "none", eye: "sleepy", flavor: "じかんを かけるほど、あじが しみて おいしくなる", image: "fuyu-r8.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr4", name: "ふゆのだんろばん", rarity: "SR", theme: "warmth", shape: "oval", color: "#b71c1c", accessory: "none", eye: "star", sparkle: true, flavor: "いえの まんなかで、ひとばんじゅう ひを まもっている", image: "fuyu-sr4.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n12", name: "ろうそくのちいさなひ", rarity: "N", theme: "winterlights", shape: "egg", color: "#fff59d", accessory: "none", eye: "dot", flavor: "ふけば きえてしまう、ちいさくて まっすぐな ひ", image: "fuyu-n12.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n13", name: "まちのイルミネーション", rarity: "N", theme: "winterlights", shape: "round", color: "#7c4dff", accessory: "none", eye: "star", flavor: "まちじゅうを いっせいに きらきらさせる", image: "fuyu-n13.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r9", name: "まどのゆげもよう", rarity: "R", theme: "winterlights", shape: "round", color: "#cfd8dc", accessory: "none", eye: "dot", flavor: "くもった まどに、ゆびで えを かける", image: "fuyu-r9.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r10", name: "ほしぞらのふゆのおおいぬ", rarity: "R", theme: "winterlights", shape: "oval", color: "#1b2a80", accessory: "none", eye: "star", flavor: "ふゆの よぞらで、いちばん あかるく ひかる", image: "fuyu-r10.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr5", name: "ゆきあかりのしずけさ", rarity: "SR", theme: "winterlights", shape: "round", color: "#e0f7fa", accessory: "none", eye: "closed", sparkle: true, flavor: "ゆきが つもった よるだけ、まちが ほんのり あかるくなる", image: "fuyu-sr5.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n14", name: "くまのねぼすけどん", rarity: "N", theme: "hibernation", shape: "round", color: "#7f5539", accessory: "none", eye: "closed", flavor: "はるまで ずっと ねている。おこしても おきない", image: "fuyu-n14.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n15", name: "りすのためこみや", rarity: "N", theme: "hibernation", shape: "egg", color: "#d2691e", accessory: "tuft", eye: "dot", flavor: "どこに かくしたか、いつも わすれてしまう", image: "fuyu-n15.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-n16", name: "かえるのつちのなか", rarity: "N", theme: "hibernation", shape: "round", color: "#4caf50", accessory: "none", eye: "closed", flavor: "つちの したで、まるくなって はるを まつ", image: "fuyu-n16.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r11", name: "ふゆごしのたねつぶ", rarity: "R", theme: "hibernation", shape: "egg", color: "#3e2723", accessory: "none", eye: "closed", flavor: "つちの したで、いちばん ちいさく なって まっている", image: "fuyu-r11.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr6", name: "ねむりのこもりうた", rarity: "SR", theme: "hibernation", shape: "oval", color: "#5e35b1", accessory: "book", eye: "closed", sparkle: true, flavor: "ふゆじゅう、つちの したの みんなに うたっている", image: "fuyu-sr6.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr7", name: "きたかぜのふきぬけ", rarity: "SR", theme: "wintersky", shape: "egg", color: "#546e7a", accessory: "none", eye: "dot", sparkle: true, flavor: "まちを いっきに ふきぬけて、みんなを ちぢこませる", image: "fuyu-sr7.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-r12", name: "しばれるあさのしろいき", rarity: "R", theme: "wintersky", shape: "round", color: "#edf3f7", accessory: "none", eye: "dot", flavor: "いきを はくと、しろく かたちに なる", image: "fuyu-r12.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-ur2", name: "オーロラのゆらめきひめ", rarity: "UR", theme: "wintersky", shape: "oval", color: "#69f0ae", accessory: "none", eye: "star", sparkle: true, flavor: "よぞらに みどりの ぬのを ひろげて ゆらめく", image: "fuyu-ur2.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-sr8", name: "ふゆのだいさんかく", rarity: "SR", theme: "wintersky", shape: "round", color: "#3949ab", accessory: "crown", eye: "star", sparkle: true, flavor: "みっつの ほしを むすんで、ふゆの よぞらを ささえる", image: "fuyu-sr8.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-ur3", name: "こおりのおおとりで", rarity: "UR", theme: "wintersky", shape: "oval", color: "#0097a7", accessory: "none", eye: "star", sparkle: true, flavor: "かわも うみも いっしゅんで こおらせる、でんせつの ふゆの ぬし", image: "fuyu-ur3.webp", releasedIn: ["ja", "es"] },
  { id: "fuyu-ur4", name: "ふゆぞらのせいれいおう", rarity: "UR", theme: "wintersky", shape: "round", color: "#bbdefb", accessory: "crown", eye: "closed", sparkle: true, flavor: "ふゆの すべての せいれいたちを まもる、しずかな おうさま", image: "fuyu-ur4.webp", releasedIn: ["ja", "es"] },
...
//    言語ごとに別の画像が要る（i18n.js の LOCALE_CARD_DIR）。
//    秋冬（80体・2026-09-16）はスペイン語の画像と CARD_NAMES.es の名前が揃ったので
//    releasedIn に "es" を足し、日本語版と同時に公開した。
//    春（40体）はスペイン語の画像がまだ無いので releasedIn: ["ja"] のまま。
//    足すときに画像が欠けていると、スペイン語版だけカード画像がリンク切れになる。
//
